...
<?foreach($arItem["PROPERTIES"]["SLIDER"]["VALUE"] as $key => $arSubProp):?>
	<?
	$arChild = $arSubProp["SUB_VALUES"];
	$RATINGS_TOP_NUM = $arItem["RATINGS_TOP_NUM"]["VALUE"];
	$RATINGS_TEXT = $arItem["RATINGS_TEXT"]["~VALUE"]["TEXT"];
	$obParser = new CTextParser;
	$RATINGS_PREVIEW_TEXT = $obParser->html_cut($RATINGS_TEXT, 120);
	$img = $arItem["RATINGS_IMG"]["VALUE"];
	$img = CFile::ResizeImageGet($img,array("width" => 129, "height" => 186),BX_RESIZE_IMAGE_PROPORTIONAL);
	?>
<?endforeach?>
